...
public class Query implements QueryPart, QueryBuilder {
	...
	public Query postprocess(final PostProcessor processor) {
	...
	private PreparedStatement prepareInternal(final Connection connection, final Integer autoGeneratedKeys)
			throws SQLException {
		final QueryOptions options = new QueryOptions().prepare(true)
				.pretty(false);
