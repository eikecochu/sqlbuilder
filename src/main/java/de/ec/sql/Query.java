...
public class Query implements QueryBuilder {
	...
	public PreparedStatement prepare(final Connection connection) throws SQLException {
		return prepare(connection, null);
	}

	public PreparedStatement prepare(final Connection connection, final Integer autoGeneratedKeys) throws SQLException {
		final QueryOptions options = safeOptions(this.options).prepare(true);
