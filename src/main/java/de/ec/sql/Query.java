...
public class Query implements QueryPart, QueryBuilder {
	...
	private PreparedStatement prepareInternal(Connection connection, Integer autoGeneratedKeys, QueryOptions options)
			throws SQLException {
		options.prepare(true).pretty(false);
	...
	public PreparedStatement prepare(Connection connection, QueryOptions options) throws SQLException {
		return prepareInternal(connection, null, options);
	}

	public PreparedStatement prepare(Connection connection, int autoGeneratedKeys, QueryOptions options)
			throws SQLException {
		return prepareInternal(connection, autoGeneratedKeys, options);
	}
